...
let testSong = new Song(1, genre.mode, songTestMoodChip)
...
console.assert(
    compareArray(testSong.scaleNotes, ["C#", "D", "E", "F#", "G#", "A", "B"]),
    {
...
console.assert(
    compareArrayOfObjects(testSong.scaleChords, [
        { name: "m", note: 3 },
        { name: "", note: 4 },
        { name: "", note: 5 },
        { name: "m", note: 6 },
...
testSong = new Song(4, 3, songTestMoodChip)
...
console.assert(
    compareArray(testSong.scaleNotes, ["F#", "G", "A", "B", "C#", "D", "E"]),
    {
